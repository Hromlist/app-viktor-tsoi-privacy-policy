...
This privacy policy is applicable to the Виктор Цой: Аккорды песен app (hereinafter referred to as "Application") for mobile devices, which was developed by Hlist studio (hereinafter referred to as "Service Provider") as a Free service. This service is provided "AS IS".
